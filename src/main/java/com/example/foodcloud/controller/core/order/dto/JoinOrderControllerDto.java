...
public class JoinOrderControllerDto {
    ...
    public JoinOrderControllerDto(String location, int count, Long bankAccountId, Long foodMenuId, Long orderMainId) {
    ...
    public OrderMenuAddServiceDto convert() {
        return new OrderMenuAddServiceDto(this.location, this.count, this.bankAccountId, this.foodMenuId, this.orderMainId);
    }
}