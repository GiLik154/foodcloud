...
@Getter
public class FoodMenuUpdaterReq {
    @NotBlank
    ...
    public FoodMenuUpdaterReq(String name, int price, Temperature temperature, FoodTypes foodTypes, MeatTypes meatType, Vegetables vegetables) {
        this.name = name;
        this.price = price;
