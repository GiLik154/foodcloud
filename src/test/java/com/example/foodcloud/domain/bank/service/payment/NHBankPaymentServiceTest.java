...
class NHBankPaymentServiceTest {
    ...
    @Autowired
    public NHBankPaymentServiceTest(Map<String, BankPaymentService> bankPaymentService, BankAccountRepository bankAccountRepository, UserRepository userRepository) {
