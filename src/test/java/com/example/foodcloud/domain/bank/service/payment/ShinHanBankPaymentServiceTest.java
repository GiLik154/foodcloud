...
class ShinHanBankPaymentServiceTest {
    private final Map<String, BankPaymentService> bankPaymentService;
    private final BankAccountRepository bankAccountRepository;
    private final UserRepository userRepository;

    @Autowired
    public ShinHanBankPaymentServiceTest(Map<String, BankPaymentService> bankPaymentService, BankAccountRepository bankAccountRepository, UserRepository userRepository) {
    ...
    void ShinHan_결제_정상작동() {
        ...
        BankAccount bankAccount = new BankAccount("test", "test", "088", user);
