...
class ShinHanBankPaymentServiceTest {
    ...
    @Autowired
    public ShinHanBankPaymentServiceTest(Map<String, PaymentService> bankPaymentService, BankAccountRepository bankAccountRepository, UserRepository userRepository) {
