...
class OrderMenuListResultUpdateServiceImplTest {
    ...
    @Autowired
    public OrderMenuListResultUpdateServiceImplTest(OrderMenuListResultUpdateService orderMenuListResultUpdateService, OrderMenuRepository orderMenuRepository, UserRepository userRepository, BankAccountRepository bankAccountRepository, RestaurantRepository restaurantRepository, FoodMenuRepository foodMenuRepository, OrderMainRepository orderMainRepository) {
    ...
    void 오더메뉴_업데이트_정상_작동() {
        ...
        OrderMenu orderMenu1 = new OrderMenu("test", 5, "test", user, bankAccount, foodMenu, orderMain);
        OrderMenu orderMenu2 = new OrderMenu("test", 5, "test", user, bankAccount, foodMenu, orderMain);
