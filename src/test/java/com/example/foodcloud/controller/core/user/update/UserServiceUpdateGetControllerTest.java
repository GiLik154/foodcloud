...
class UserServiceUpdateGetControllerTest {
    ...
    @Autowired
    public UserServiceUpdateGetControllerTest(UserUpdateController userUpdateController, UserExceptionAdvice userExceptionAdvice, UserRepository userRepository) {
