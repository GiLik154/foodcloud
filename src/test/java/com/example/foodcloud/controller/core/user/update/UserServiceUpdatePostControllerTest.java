package com.example.foodcloud.controller.core.user.update;
...
class UserServiceUpdatePostControllerTest {
    ...
    @Autowired
    public UserServiceUpdatePostControllerTest(UserUpdateController userUpdateController, UserExceptionAdvice userExceptionAdvice, UserRepository userRepository) {
