package com.example.foodcloud.controller.core.restaurant.restaurant.update;
...
class RestaurantUpdateGetControllerTest {
    ...
    @Autowired
    public RestaurantUpdateGetControllerTest(RestaurantUpdateController restaurantUpdateController, RestaurantRepository restaurantRepository, UserRepository userRepository, ParamValidateAdvice paramValidateAdvice) {
