...
class UserDeleteGetControllerTest {
    ...
    @Autowired
    public UserDeleteGetControllerTest(UserDeleteController userDeleteController, UserExceptionAdvice userExceptionAdvice, UserRepository userRepository, PasswordEncoder passwordEncoder) {
