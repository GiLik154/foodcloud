...
class BankUpdateGetControllerTest {
    ...
    @Autowired
    public BankUpdateGetControllerTest(WebApplicationContext context, UserRepository userRepository, BankAccountRepository bankAccountRepository) {
    ...
    void 계좌_업데이트_정상출력() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = get("/bank/update/" + bankAccount.getId());

        mockMvc.perform(builder)
                .andExpect(status().isOk())
                .andExpect(view().name("thymeleaf/bank/update"))
