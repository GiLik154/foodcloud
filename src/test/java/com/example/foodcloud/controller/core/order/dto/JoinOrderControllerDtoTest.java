...
class JoinOrderControllerDtoTest {
    @Test
    void Post_주문_추가_Dto() {
        JoinOrderControllerDto joinOrderControllerDto = new JoinOrderControllerDto("testLocation", 5, 1L, 2L);
        ...
        assertEquals(2L, joinOrderControllerDto.getOrderMainId());
    }
    ...
    void Post_주문_추가_Dto_Convert() {
        ...
        OrderMenuAddServiceDto orderMenuAddServiceDto = joinOrderControllerDto.convert();
