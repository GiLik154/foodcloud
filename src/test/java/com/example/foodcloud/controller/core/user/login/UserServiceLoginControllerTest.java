...
class UserServiceLoginControllerTest {
    ...
    @Autowired
    public UserServiceLoginControllerTest(UserLoginController userLoginController, UserExceptionAdvice userExceptionAdvice, UserRepository userRepository, PasswordEncoder passwordEncoder) {
