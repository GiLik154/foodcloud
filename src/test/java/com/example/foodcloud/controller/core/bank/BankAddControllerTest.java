...
import com.example.foodcloud.controller.core.bank.BankAddController;
...
class BankAddControllerTest {
    ...
    @Autowired
    BankAddControllerTest(BankAddController bankAddController, UserExceptionAdvice userExceptionAdvice, LoginInterceptor loginInterceptor, UserRepository userRepository, BankAccountRepository bankAccountRepository) {
